...
export const Projects: React.FC = () => {
  ...
  const filteredProjects = React.useMemo(() => {
    return mockProjects.filter((project) => {
      ...
      // For now, we don't have archived projects in mock data
  ...
  const projectStats = {
    ...
    active: mockProjects.length,
    archived: 0,
    onTrack: mockProjects.filter((p) => p.health === 'onTrack').length,
    atRisk: mockProjects.filter((p) => p.health === 'atRisk').length,
    behind: mockProjects.filter((p) => p.health === 'behind').length,
  };
